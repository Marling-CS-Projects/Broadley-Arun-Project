...
First i started by adding all the different parameters that ive allowed users to find correlations with and ive added them all to an array, inside this array ive used the function "doRegression" to perform regression analysis on these parameters to find different information like the "slope", "gradient" and most importantly r^2.
