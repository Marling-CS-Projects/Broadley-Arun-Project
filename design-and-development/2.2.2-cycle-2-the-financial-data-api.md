...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>EOD Dashboard</p></figcaption></figure>
...
Once the user has selected an exchange using the information we use above , the next thing we will have to do is download the stock items&#x20;
