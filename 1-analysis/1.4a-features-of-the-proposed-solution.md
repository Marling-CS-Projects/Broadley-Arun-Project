...
The user interface is split into 3 separate components. These are described below in the feature sections
...
Stock Growth: amount stock that grew that day. (prior day close to current day close)
...
Depending on the grid I use , I may have to limit how many lines of history I can show the user.&#x20;
