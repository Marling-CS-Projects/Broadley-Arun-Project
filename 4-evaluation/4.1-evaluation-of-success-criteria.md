...
This criterion has been successfully completed. To accommodate the large range of exchanges and stocks for which I had data for with the intention to share to the user, I decided to use a dropdown box, as it offered an efficient and user-friendly way of showing these options.
...
This criterion has been successfully completed.  I wamted to display all availiable data about the stocks that I have access to, to the users so they can mak there own informed decisions. I displayed this data in the form of a table with collums and rows representing different parameters and key data points.
