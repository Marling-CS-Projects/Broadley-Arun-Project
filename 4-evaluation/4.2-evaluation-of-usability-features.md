...
I think the analysis page because of all the help describing the key variables from the regression test, helps the user understand that actual results. For instance here we can see that the correlation between the 2 parameters we have chosen to analyse is very low at R=0.02362.
