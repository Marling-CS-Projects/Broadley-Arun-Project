...
Most of my non-functional requirements passed. One though was adding a legal disclaimer which I forgot when doing the initial development. I have now added. Another one that was more of a problem was localisation of number formats. This seems quite difficult to do. I could not find a way of reading the local PC's number format from javascript. Other solutions like google docs don't seem to do it either.
